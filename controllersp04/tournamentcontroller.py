...
class TournamentController:
    ...
    def display_view_no_tournament_finished(self):
        return self.view_finished.display_view_no_tournament_finished()
        pass
    ...
    def new_tournament(self):
        ...
        new_tournament.append(self.view_start.input_match_in_round())
    ...
    def check_match_in_round(self, input_match_in_round):
        ...
        if input_match_in_round.isdigit() == True:
            ...
            return self.view_start.input_match_in_round("TRUE")
