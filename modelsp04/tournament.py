...
class Tournament:
    ...
    def __init__(self, tournament_oontroller, index=int(), name="", place="", participants_status=list, round=4, match_in_round=int(), time_control=list, description=""):
    ...
    def add_tournament(self, new_tournament):
        ...
        participants_status = new_tournament[2]
        ...
        self.tournament_in_progress = Tournament("tournament_controller", index,
                                                 name, place, participants_status,
    ...
    def new_round(self, tournament_in_progress):
        ...
        # Ancien avant optimisation, à supp dès que sur que pas de problème avec le nouveau
        ...
        #             participants_validate["player_index_{}".format(int(participant))] = player
        #         else:
        #             pass
